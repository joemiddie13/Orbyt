	...
	<div bind:this={panel} class="glass-panel rounded-2xl w-full max-w-md mx-4 max-h-[85vh] flex flex-col relative" style="will-change: transform, box-shadow;">
		...
		<div bind:this={contentBlock} class="flex-1 overflow-y-auto px-6 pb-5 pt-2 relative z-10" style="display: flex; flex-direction: column; gap: 0.75rem;">
			...
			<div class="flex items-center relative">
				<label bind:this={musicLabel} class="text-sm font-semibold uppercase tracking-wider text-center flex-1" style="font-family: 'Satoshi', sans-serif; color: {TEAL}; text-shadow: 0 0 8px rgba({TEAL_RGB}, 0.3);">Music Link</label>
				<button
					onclick={handleClose}
			...
			<div>
				<div class="flex gap-2">
					<input
						...
						class="glass-input flex-1 rounded-lg px-3 py-2.5 text-sm"
			...
			<div class="flex items-center gap-4 flex-wrap">
				<span class="platform-chip">
					...
					<span class="text-xs text-white/40" style="font-family: 'Satoshi', sans-serif;">Spotify</span>
				</span>
				<span class="platform-chip">
					...
					<span class="text-xs text-white/40" style="font-family: 'Satoshi', sans-serif;">YouTube</span>
				</span>
				<span class="platform-chip">
					...
					<span class="text-xs text-white/40" style="font-family: 'Satoshi', sans-serif;">YouTube Music</span>
				</span>
				<span class="platform-chip">
					...
					<span class="text-xs text-white/40" style="font-family: 'Satoshi', sans-serif;">Apple Music</span>
				</span>
			</div>
			...
			{#if preview}
				<div class="preview-card">
					...
					<div class="preview-info">
						<p class="text-sm font-semibold text-white truncate" style="font-family: 'Satoshi', sans-serif;">{preview.title}</p>
						{#if preview.artist}
							<p class="text-xs text-white/60 truncate" style="font-family: 'Satoshi', sans-serif;">{preview.artist}</p>
						{/if}
						<span class="text-[10px] font-medium mt-1 inline-block" style="color: {PLATFORM_COLORS[preview.platform] ?? '#888'}; font-family: 'Satoshi', sans-serif;">{PLATFORM_LABELS[preview.platform] ?? preview.platform}</span>
					</div>
				</div>
			{/if}
			...
			<!-- Error -->
			{#if error}
				<p class="text-xs text-red-400" style="font-family: 'Satoshi', sans-serif;">{error}</p>
			{/if}
